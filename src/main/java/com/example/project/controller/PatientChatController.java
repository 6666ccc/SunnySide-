...
import com.example.project.ai.client.PatientAIChat;
...
public class PatientChatController {
    ...
    @Autowired
    private PatientAIChat patientAIChat;
    ...
    public SseEmitter chat(@RequestAttribute("userId") String jwtSubject,
        ...
        Disposable subscription = patientAIChat.stream(timeId, message, jwtSubject).subscribe(chunk -> {
            try {
